...
OpenTranscribe is open-source software licensed under the GNU Affero General Public License v3.0 (AGPL-3.0). This license ensures that all users, including those accessing the software over a network, have access to the source code. See [LICENSE](https://github.com/attevon-llc/OpenTranscribe/blob/master/LICENSE) for details.

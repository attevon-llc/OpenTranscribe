...
- Deferred by design (tracked as a follow-up): OpenSearch snapshots (derived data — rebuildable from Postgres; a setting + extension seam exist) and MinIO media mirroring.
